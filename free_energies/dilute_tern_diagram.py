...
# Calculates the limit of single-phase stability of a phase expressed as a
# dilute-free energy of mixing
...
def E_mix(x,y,n):
    """
    Returns the energy of mixing for the phase under consideration.
    """
